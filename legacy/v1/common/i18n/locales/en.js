...
const messages = {
  ...
  flow: {
    drawer: {
      ...
      noteTitle: 'Tips',
      noteText:
        'Timeout applies per step. Retry counts include the first attempt. Use assert steps to fail fast when a selector is missing.',
    },
    actions: {
      addStep: 'Add step',
      deleteStep: 'Delete',
    ...
    form: {
      selector: 'Selector',
      value: 'Value',
      valuePlaceholder: 'Text to input',
      ...
      assertMessagePlaceholder: 'Assertion message (optional)',
      timeout: 'Timeout (ms)',
      timeoutPlaceholder: 'e.g. 8000',
      retry: 'Retry',
      type: {
        click: 'Click',
        input: 'Input',
      ...
      assertSelector: 'Assert selector exists',
    },
    messages: {
      missingTarget: 'Select an element first.',
      runPrereq: 'Activate a tab and element before running.',
      runStarted: 'Flow started.',
      runError: 'Unable to start flow: {error}',
      saveSuccess: 'Flow saved.',
      saveError: 'Unable to save flow: {error}',
      pauseSuccess: 'Flow paused.',
      pauseError: 'Unable to pause: {error}',
      resumeSuccess: 'Flow resumed.',
    ...
    library: {
      ...
      description: 'Create reusable flows and bind them to buttons.',
      createAction: 'New flow',
      createTitle: 'Create flow',
      editTitle: 'Edit flow',
      subtitle: 'Build once, reuse everywhere.',
      templateLabel: 'Use existing flow',
      templatePlaceholder: 'Select a flow',
      name: 'Name',
      namePlaceholder: 'My flow',
      descriptionField: 'Description',
      descriptionPlaceholder: 'What this flow does',
      defaultElementFlowName: '{label} button flow',
      summary: 'Overview',
      stepsCount: '{count} step(s)',
      saveAndRun: 'Save & run',
      errorName: 'Enter a flow name.',
      errorSelect: 'Select a flow to continue.',
      noDescription: 'No description',
      empty: 'No flows yet. Create one to get started.',
    },
  },
  hidden: {
    heading: 'Hidden elements',
    description: 'Hide elements on this page or site.',
    add: 'Add rule',
    cancel: 'Cancel',
    save: 'Save rule',
    enabled: 'Enabled',
    disabled: 'Disabled',
    empty: 'No hidden rules yet.',
    defaultName: 'Hidden rule',
    notePlaceholder: 'Optional note',
    error: {
      selector: 'Please provide a selector to hide.',
    },
    form: {
      name: 'Name',
      selector: 'Selector',
