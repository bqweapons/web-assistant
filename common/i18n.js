...
const messages = {
  ...
  ja: {
    ...
    editor: {
      ...
      errorFlowInvalid: '有効なアクションフローを入力してください: {error}',
  ...
  'zh-CN': {
    ...
    editor: {
      ...
      actionFlowPlaceholder: '[\n  {"type":"click","selector":"#target"}\n]',
      actionFlowHintDefault:
        '可选的 JSON 数组，用于描述连续步骤（最多 {limit} 个字符）。支持 click、wait、input、if、while、navigate。',
      actionFlowHintConfigured: '流程已配置，共 {count} 步。',
      ...
      errorFlowInvalid: '请输入有效的动作流程：{error}',
      previewButton: '按钮预览',
      previewLink: '链接预览',
