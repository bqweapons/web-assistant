...
mergeMessages(jaMessages, {
  ...
  editor: {
    ...
    actionFlowConfigure: 'フローを編集',
    actionFlowSummaryUnavailable: 'アクションフローはボタンでのみ利用できます。',
    actionFlowSummaryError: 'フローエラー: {error}',
    actionFlowSummaryConfigured: 'フローが {count} ステップで設定されています。',
    actionFlowSummaryEmpty: 'アクションフローはまだ設定されていません。',
    actionFlowTitle: 'アクションフローを編集',
    actionFlowDescription: 'ボタンがクリックされた後に実行する一連の操作を作成します。',
...
mergeMessages(zhCNMessages, {
  ...
  editor: {
    ...
    actionFlowSummaryUnavailable: '动作流程仅适用于按钮。',
    actionFlowSummaryError: '流程错误：{error}',
    actionFlowSummaryConfigured: '已配置 {count} 个步骤的流程。',
    actionFlowSummaryEmpty: '尚未配置动作流程。',
    actionFlowTitle: '配置动作流程',
    actionFlowDescription: '设置访客点击按钮后要依次执行的操作。',
